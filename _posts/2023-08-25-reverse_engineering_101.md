...
- [GNU Binutils](https://www.gnu.org/software/binutils/): A suit of utilities for Linux binaries. Contains the popular tool [strings](https://linux.die.net/man/1/strings) which can be used to find readable strings in binaries and [objdump](https://linux.die.net/man/1/objdump)
- Analysers, such as:
