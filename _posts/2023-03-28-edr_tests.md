...
After you've decided on the new attacks you're going to test, you will now run them! Whether you've gone for the isolated emulation network or the real organisation's network route, you should make sure that all of your data shippers and detection software are running properly. This activity in general will assess their capabilities. In this stage, attacks can be automated or even just document using tools like [CALDERA](https://github.com/mitre/caldera), [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team), and [SCYTHE](https://scythe.io/). These platforms are differentt and have different features. I'd recommend looking at their overviews and comparisons between them before using them!
