...
Update, 2<sup>nd</sup> Sep. 2024: I created the [pull request for WiringX and it got merged](https://github.com/wiringX/wiringX/pull/127). We've also discussed the possibility of merging Milk-V's fork into upstream WiringX to honour the purpose of the library supporting as many platforms as possible without needing forks.
{:.success}
