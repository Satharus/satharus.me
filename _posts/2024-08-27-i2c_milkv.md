...
Now you may be wondering, what does milk have to do with RISC-V? I honestly have no clue. Anyways, we have a cheap SBC, half-baked documentation, and a drea... I mean a goal of running I<sup>2</sup>C functionally on it.
...
Note: I've chosen to extract the toolchain to `/opt/riscv-musl`. If you've chosen another path, then change the paths accordingly.
{:.info}
